...
. 
در مقاله‌های \cite{irf8, irf8-2} گفته شده که ژن \lr{IRF8} (که در پایگاه‌داده )\lr{ENCODE  and ChEA Consensus TFs from} کمتر بیان شده است
...
\subsection*{ب)}
در مقاله \cite{irf8} به دارویی اشاره شده است که برای درمان \lr{AML} باید مقدار بیان این ژن را افزایش داد
